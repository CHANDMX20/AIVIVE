...
cols = pd.read_csv('path/to/module64_genes.csv').PROBEID.unique()
print(len(cols))                   
...
def save_final_model(model, predsPath, step):
    ...
    filename = predsPath + f'/model64_final_epoch_{step:06d}.h5'
...
predsPath = path+'/predictions_decoded/train/module64'

#generated csv: vivo train preds for module 64
number = '9962160'
vivo_opt_gen_train = save_preds(predictions, X_train, train_input, predsPath+ '/opt_gen_train' + number + '_Vivo_64.csv')
