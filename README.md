...
- **Files**:
  - [`AOP.ipynb`](./applications/AOP.py) - Jupyter notebook for calculating the **percentage error** in gene expression values between real and **GenLocGAN-generated** profiles, followed by **visualization** using a heatmap to identify patterns in gene expression between the two profiles.
